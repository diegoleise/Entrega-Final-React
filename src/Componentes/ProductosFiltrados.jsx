...
const ProductosFiltrados = () => {
    ...
    return (
        <>
            ...
            <div style={{gap:'10px', display:'flex', justifyContent:'center',marginTop: '20pxp', }}><input style={{borderRadius:'10px', marginTop:'10px', marginTop:'10px', padding:'5px', flexWrap:'wrap'}}
